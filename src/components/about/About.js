          ...
          <Tabs position='relative' variant='unstyled' className='tabs'>
            ...
            <TabPanel className='tabpanel1'>
                <div className='skills'>
                  <div className='skills1'>
                    <ul>
                      ...
                      <li><span className='logo'><img src={nextjs} alt="" /></span>Next Js</li>
                    </ul>
                  </div>
                  <div className='skills1'>
                    <ul>
              ...
              <TabPanel className='tabpanel2'>
                <h3 style={{marginBottom:'5px', color:'#ff6699'}}>2024 - Present</h3>

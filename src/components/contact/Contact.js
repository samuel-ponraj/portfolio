    ...
    <div id='contact' className="contact-container">
      <div className="contact">
          <div className="contact-left" data-aos="fade-right">
            ...
            <a href="https://drive.google.com/file/d/1i2OT063rGu1xwtfrd1pu8qe_oQTIAsiG/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='btn'>Download Resume</a>
          </div>
